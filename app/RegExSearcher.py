...
# Layout for the GUI
menubar_layout = [[sg.MenubarCustom(MENU_DEFINITION, bar_background_color="#4d5157", bar_text_color="#FFFFFF",background_color="#4d5157",text_color="#FFFFFF")]]
...
main_frame = sg.Frame("Main Program Frame", main_layout, expand_x=True, expand_y=True,
...
while True:
    ...
    if event == "-SEARCH-":
        ...
        if validate_headers(headers, len(patterns)):
            ...
            results = regex_search(text, patterns)
